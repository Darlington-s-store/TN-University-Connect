    ...
    <footer className="bg-secondary text-secondary-foreground">
      <div className="container mx-auto px-4 sm:px-6 py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/70">
            <li><Link to="/login" className="hover:text-accent">Member Login</Link></li>
            ...
            <li><Link to="/student-info" className="hover:text-accent">Student Info Form</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/70">
            <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5 text-accent shrink-0" /> Accra, Greater Accra Region, Ghana</li>
            <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-accent shrink-0" /> +233 30 250 0000</li>
            <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-accent shrink-0" /> hello@tnuc.gh</li>
          </ul>
        </div>
      </div>
