    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="hidden lg:flex hero-gradient text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-white/80 max-w-md">A nationwide community of students, alumni and universities, building Ghana's future together.</p>
        ...
        <div className="relative z-10 text-sm text-white/60">© {new Date().getFullYear()} TN Universities Connect</div>
      </div>
