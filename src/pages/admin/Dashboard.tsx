          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Student registrations over the past 6 months</p>
              </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="relative h-[240px]">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={byUni} dataKey="value" nameKey="name" outerRadius={80} innerRadius={60} paddingAngle={5}>
              ...
              <tbody className="divide-y divide-border">
                {students.slice(0, 5).map((s) => (
                  <tr key={s.id} className="hover:bg-muted/20 transition-colors">
                    ...
                    <td className="px-6 py-4 text-muted-foreground">{new Date(s.submittedAt).toLocaleDateString("en-GB")}</td>
